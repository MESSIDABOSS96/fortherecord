...
function LyricCard({ record, onClick }: RecordCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="cursor-pointer rounded-2xl p-5 transition-all hover:scale-[1.01] hover:shadow-lg flex flex-col"
      style={{
    ...
    >
      ...
      <div className="flex items-start gap-3 mb-4 flex-shrink-0">
        <div className="w-12 h-12 bg-black/20 rounded-lg flex-shrink-0 overflow-hidden">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-[13px] text-gray-700 truncate leading-tight mt-0.5">
            {record.artist}
          </div>
        </div>
      </div>

      {/* Lyric excerpt with size-based clamping */}
      <div
        className="text-gray-900 font-bold text-[19px] leading-[1.3] mb-4 flex-1 overflow-hidden whitespace-pre-line"
        style={{
          display: '-webkit-box',
          WebkitLineClamp: sizeConfig.maxLines,
      ...
      {/* For label */}
      <div className="text-[11px] font-medium italic text-gray-800 uppercase tracking-wider flex-shrink-0">
